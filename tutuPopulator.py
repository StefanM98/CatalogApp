...
catagory1 = Catagory(user_id=1, name="My Little Poney")
...
catagoryItem3 = Item(user_id=1, name="Rainbow Dash", description="Tutu based off of Rainbow Dash from My Little Ponies.",
                     image="/images/RainbowDash.svg", catagory=catagory1)

session.add(catagoryItem3)
session.commit()

catagoryItem4 = Item(user_id=1, name="Twilight Sparkle", description="Tutu based off of Twilight from My Little Ponies.",
                     image="/images/twilight.svg", catagory=catagory1)

session.add(catagoryItem4)
session.commit()

catagoryItem5 = Item(user_id=1, name="Fluttershy", description="Tutu based off of Fluttershy from My Little Ponies.",
                     image="/images/fluttershy.svg", catagory=catagory1)

session.add(catagoryItem5)
session.commit()

catagoryItem6 = Item(user_id=1, name="Rarity", description="Tutu based off of Rarity from My Little Ponies.",
